export const bg = {
  ...
  'mailboxes.emailInfo': 'Имейл адресът, който ще се показва като изпращач в изходящите имейли. Трябва да съответства на адрес, верифициран в AWS SES.',
  'mailboxes.imapHost': 'IMAP сървър',
  'mailboxes.imapHostInfo': 'Хостнеймът на вашия пощенски сървър. Намерете го в настройките на доставчика или хостинг панела (напр. cPanel → Email Accounts → Connect Devices).',
  'mailboxes.imapPort': 'IMAP порт',
  'mailboxes.imapUser': 'IMAP потребител',
  'mailboxes.imapUserInfo': 'Потребителското име за влизане в IMAP сървъра. Обикновено съвпада с имейл адреса, но може да се различава при споделени или делегирани пощенски кутии.',
